...
public class ItemRedBoat extends Item
{
    public ItemRedBoat(int i)
    {
        super(i);
        maxStackSize = 1;
            ...
            else
            {
                if (var24.typeOfHit == EnumMovingObjectType.TILE)
                {
                    ...
                    if (!par2World.isRemote)
                    {
                        ...
                        par2World.spawnEntityInWorld(new EntityRedBoat(par2World, (double)(var35 + 0.5F), (double)(var33 + 1.0F), (double)(var34 + 0.5F)));
                    }
