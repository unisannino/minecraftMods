...
public class ModelRSBGolem extends ModelBase
{
    private static final EntityRSBGolem entityirongolem = null;
    ...
    public ModelRSBGolem()
    {
        this(0.0F);
    }

    public ModelRSBGolem(float par1)
    {
        this(par1, -7F);
    }

    public ModelRSBGolem(float par1, float par2)
    {
        char c = '\200';
        char c1 = '\200';
    ...
    {
        EntityRSBGolem golem = (EntityRSBGolem)par1EntityLiving;
        int i = golem.func_48114_ab();

        if (i > 0)
        {
            field_48233_c.rotateAngleX = -2F + 1.5F * func_48228_a(i - par4, 10F);
            field_48230_d.rotateAngleX = -2F + 1.5F * func_48228_a(i - par4, 10F);
        }
        else
        {
            int j = golem.func_48117_D_();
        ...
        if(golem.getSitState())
        {
            field_48233_c.rotateAngleX = -0.8F + 0.025F * func_48228_a(800, 70F);
            field_48230_d.rotateAngleX = -0.8F + 0.025F * func_48228_a(800, 70F);
        }
    }
