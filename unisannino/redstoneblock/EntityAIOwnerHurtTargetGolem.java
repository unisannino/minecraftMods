...
public class EntityAIOwnerHurtTargetGolem extends EntityAITarget
{
    EntityRSBGolem golem;
    EntityLiving targetEntity;

    public EntityAIOwnerHurtTargetGolem(EntityRSBGolem par1EntityTameable)
    {
    ...
    public boolean shouldExecute()
    {
        ...
        {
            targetEntity = entityliving.getLastAttackingEntity();
