...
public class RenderMinecartRF extends RenderMinecart
{
    public RenderMinecartRF()
    {
    	super();
    }
     ...
     */
    public void renderTheMinecartRF(EntityMinecartRF cart, double par2, double par4, double par6, float par8, float par9)
    {
        GL11.glPushMatrix();
        ...
        (new RenderBlocks()).renderBlockAsItem(Mod_RSB_Core.RedFurnaceIdle, 0, cart.getBrightness(par9));
        ...
        if(cart.getExplode() > 1)
        {
            if ((cart.getExplode() - par8) + 1.0F < 10F)
            {
                float var31 = 1.0F - ((cart.getExplode() - par8) + 1.0F) / 10F;
                ...
                var31 *= var31;
                var31 *= var31;
                float var32 = 1.0F + var31 * 0.3F;
                GL11.glScalef(var32, var32, var32);
            }

            if ((cart.getExplode() / 5) % 2 == 0)
            {
            	float var33 = 1.05F;
                ...
                this.loadTexture("/terrain.png");
                GL11.glScalef(var29 * var33, var29 * var33, var29 * var33);
                GL11.glTranslatef(0.0F, -0.3125F, 0.0F);
                (new RenderBlocks()).renderBlockAsItem(Block.dirt, 0, 1.0F);
                GL11.glRotatef(-90.0F, 0.0F, 1.0F, 0.0F);
                GL11.glTranslatef(0.0F, 0.3125F, 0.0F);
                GL11.glScalef(1.0F / var29 * var33, 1.0F / var29 * var33, 1.0F / var29 * var33);
                GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
                this.loadTexture("/item/cart.png");
                GL11.glScalef(-1.0F, -1.0F, 1.0F);
                this.modelMinecart.render(cart, 0.0F, 0.0F, -0.1F, 0.0F, 0.0F, 0.0625F);
    ...
    {
        this.renderTheMinecartRF((EntityMinecartRF)par1Entity, par2, par4, par6, par8, par9);
    }
}
