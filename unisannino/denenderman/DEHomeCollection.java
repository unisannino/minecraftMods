...
public class DEHomeCollection extends WorldSavedData
{
     ...
     * distance.
     */
    public DEHome findNearestDEHome(int par1, int par2, int par3, int par4)
    {
    	DEHome var5 = null;
    ...
    private void addNewDoorsToVillageOrCreateVillage()
    {
        ...
        while (var1.hasNext())
        {
        	DEHomeGateInfo var2 = (DEHomeGateInfo)var1.next();
            boolean var3 = false;
    ...
    private void addUnassignedWoodenDoorsAroundToNewDoorsList(ChunkCoordinates par1ChunkCoordinates)
    {
        ...
        for (int var5 = par1ChunkCoordinates.posX - var2; var5 < par1ChunkCoordinates.posX + var2; ++var5)
        {
            for (int var6 = par1ChunkCoordinates.posY - var3; var6 < par1ChunkCoordinates.posY + var3; ++var6)
            {
                ...
                {
                    if (this.isFanceGateAt(var5, var6, var7))
                    {
    ...
    private DEHomeGateInfo getVillageDoorAt(int par1, int par2, int par3)
    {
    ...
    private void addDoorToNewListIfAppropriate(int par1, int par2, int par3)
    {
        ...
        if (var4 == 0 && var4 == 2)
        {
            ...
            if (var5 != 0)
            {
                this.newDoors.add(new DEHomeGateInfo(par1, par2, par3, 0, var5 > 0 ? -2 : 2, this.tickCounter));
            }
        }
        else
        {
            ...
            if (var5 != 0)
            {
                this.newDoors.add(new DEHomeGateInfo(par1, par2, par3, var5 > 0 ? -2 : 2, 0, this.tickCounter));
            }
        }
    }
    ...
    private boolean isFanceGateAt(int par1, int par2, int par3)
    {
